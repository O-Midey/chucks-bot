    ...
    try {
      switch (session.state) {
        ...
        case STATES.HEALTH_REG_SURNAME:
          return await HealthInsuranceHandler.handleSurname(userId, input, text);
        case STATES.HEALTH_REG_MIDDLENAME:
          return await HealthInsuranceHandler.handleMiddleName(userId, input, text);
        case STATES.HEALTH_REG_FIRSTNAME:
          return await HealthInsuranceHandler.handleFirstName(userId, input, text);
        ...
        case STATES.HEALTH_REG_ADDRESS:
          return await HealthInsuranceHandler.handleAddress(userId, input, text);
        ...
        case STATES.HEALTH_REVIEW_EDIT:
          return await HealthInsuranceHandler.handleReviewEdit(userId, input, text);
        case STATES.HEALTH_PERSONAL_EDIT:
          return await HealthInsuranceHandler.handlePersonalEdit(userId, input, text);
