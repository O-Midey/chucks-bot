    ...
    try {
      switch (session.state) {
        ...
        case STATES.HEALTH_USER_TYPE:
          return HealthInsuranceHandler.handleUserType(userId, input, text);
        case STATES.HEALTH_AGE:
          return HealthInsuranceHandler.handleAge(userId, input, text);
        case STATES.HEALTH_STATE:
          return HealthInsuranceHandler.handleState(userId, input, text);
        case STATES.HEALTH_CONDITIONS:
          return HealthInsuranceHandler.handleConditions(userId, input, text);
        case STATES.HEALTH_PLANS:
          return HealthInsuranceHandler.handlePlans(userId, input, text);
