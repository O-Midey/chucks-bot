...
import { serverLogger } from "./utils/comprehensiveLogger.js";
...
export class MessageRouter {
  static async route(userId, text) {
    ...
    serverLogger.user.input(userId, text, session?.state || "unknown");
    ...
    try {
      ...
      serverLogger.error("Error in message routing", error, { userId, text });
      return {
        message:
